...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('assinatura', '0023_rename_assinatura_solicitante'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assinaturas', models.ManyToManyField(blank=True, limit_choices_to={'estado': 'vigente'}, null=True, to='assinatura.assinatura')),
